          ...
          <div className="about">
            <div className="columns">
              ...
              <div className="quote column is-one-quarter">
                the greatest adventure is not where you go but who you are with.
              </div>
            </div>
          </div>
          <div className="columns">
      ...
      <div className="columns">
        ...
        <div className="timeline column is-two-thirds columns">
          <div className="column">
            ...
            <p className="regText">
              Everything we put on our registery are things we'll love, but
              honestly, the most important gift you can bring us is having you
              and your dancing shoes at our celebration. We are pumped to spend
              out special day with you and are very blessed to have you in our
              lives.
            </p>
          </div>
          <div className="column"></div>
