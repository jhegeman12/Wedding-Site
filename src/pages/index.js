            ...
            <div className="container" data-sal="fade-in" data-sal-delay="500" data-sal-easing="ease" data-sal-duration='1000'>
                ...
                <div className="columns">
                  ...
                  <div className="column">
                    ...
                    <p className="detailsText">The wedding ceremony will begin at 3:45 pm on October 15 in the lawn adjacent to the Olympic Valley Lodge. Cocktail attire is requested (The Groom will be wearing a navy suit with a bow tie, for reference). The ceremony will be held outside, please plan to dress accordingly. We ask that guests not take their own photos during the ceremony. </p>
                  </div>
                  <div className="column">
