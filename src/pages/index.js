              ...
              <div className="columns">
                 <div className="column">
                  ...
                  <div className="column">
                    ...
                    <p className="detailsText">Unfortunately, it does not appear the pandemic will come to a quick end. For the safety of the Lake Tahoe community and all guests attending, we are requiring that all guests be fully vaccinated adn boosted against COVID 19. If there are circumstances where you cannot get vaccinated, please talk to Joseph and Mikhaila. COVID information will likely change between now and October, so please stay up to date with California COVID and travel policies. We will also continue to update this page.</p>
                 </div>
                 </div>
                </div>
